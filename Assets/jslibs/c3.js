...
!function (t, e) {
  ...
  function m(t) {
    var e = d(t),
    i = [
      t.pathSegList.getItem(0),
      t.pathSegList.getItem(1)
    ];
    return {
      x: i[0].x,
  ...
  e.prototype.copyScale = function () {
    var t,
    e = this.scale.copy();
    return this.params.isCategory && (t = this.scale.domain(), e.domain([t[0],
    t[1] - 1])),
    e
  },
  ...
  e.prototype.tspanData = function (t, e, i) {
    var n = this,
    r = n.params.tickMultiline ? n.splitTickText(t, i) : [
  ...
  e.prototype.generateAxis = function () {
    ...
    function T(t, m) {
      ...
      return t.each(function () {
        ...
        c = s.enter().insert('g', '.domain').attr('class', 'tick').style('opacity', 0.000001),
        d = s.exit().remove(),
        l = s.merge(c);
        b.isCategory ? (w.tickOffset = Math.ceil((a(1) - a(0)) / 2), e = w.tickCentered ? 0 : w.tickOffset, i = w.tickCentered ? w.tickOffset : 0) : w.tickOffset = e = 0,
        w.updateRange(),
        w.updateTickLength(),
  ...
  t.prototype.getXAxis = function (t, e, i, n, r, a, o) {
    ...
    s.isCategorized() && (l.tickCentered(c.axis_x_tick_centered), u(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
    l
  },
  ...
  t.prototype.generateTickValues = function (t, e, i) {
    ...
    if (e) if (1 === (n = h(e) ? e() : e)) l = [
      ...
      for (o = n - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (1 + o), l = [
        r
      ], c = 0; c < o; c++) d = + r + s * (c + 1),
  ...
  l.prototype.initWithData = function (t) {
    ...
    n.selectChart.empty() && (n.selectChart = r.select(document.createElement('div')).style('opacity', 0), n.observeInserted(n.selectChart), o = !1),
    ...
    o && (n.updateDimension(), n.config.oninit.call(n), n.redraw({
      withTransition: !1,
      withTransform: !0,
      withUpdateXDomain: !0,
  ...
  l.prototype.redraw = function (t, e) {
    ...
    H = X ? z : 0,
    N = M ? z : 0;
    if (e = e || x.axis.generateTransitions(N), k && S.legend_show ? x.updateLegend(x.mapToIds(x.data.targets), t, e) : D && x.updateDimension(!0), x.isCategorized() && 0 === A.length && x.x.domain([0,
    x.axes.x.selectAll('.tick').size()]), A.length ? (x.updateXDomain(A, E, O, I), S.axis_x_tick_values || (u = x.axis.updateXAxisTickValues(A))) : (x.xAxis.tickValues([]), x.subXAxis.tickValues([])), S.zoom_rescale && !t.flow && (p = x.x.orgDomain()), x.y.domain(x.getYDomain(A, 'y', p)), x.y2.domain(x.getYDomain(A, 'y2', p)), !S.axis_y_tick_values && S.axis_y_tick_count && x.yAxis.tickValues(x.axis.generateTickValues(x.y.domain(), S.axis_y_tick_count)), !S.axis_y2_tick_values && S.axis_y2_tick_count && x.y2Axis.tickValues(x.axis.generateTickValues(x.y2.domain(), S.axis_y2_tick_count)), x.axis.redraw(N, T), x.axis.updateLabels(V), (E || R) && A.length) if (S.axis_x_tick_culling && u) {
    ...
    C && (x.subY.domain(x.getYDomain(A, 'y')), x.subY2.domain(x.getYDomain(A, 'y2'))),
    x.updateXgridFocus(),
    ...
    z && x.isTabVisible() ? (l = m.transition().duration(z), s = [
    ], [
      x.redrawBar(n, !0, l),
      x.redrawLine(r, !0, l),
      x.redrawArea(i, !0, l),
    ...
    })) : (x.redrawBar(n), x.redrawLine(r), x.redrawArea(i), x.redrawCircle(f, _), x.redrawText(a, o, t.flow), x.redrawRegion(), x.redrawGrid(), d && d(), S.onrendered && S.onrendered.call(x)),
  ...
  l.prototype.updateAndRedraw = function (t) {
    ...
    n = i.config;
    (t = t || {
    }).withTransition = B(t, 'withTransition', !0),
  ...
  l.prototype.updateSvgSize = function () {
    ...
    t.svg.selectAll(['#' + t.clipId,
    '#' + t.clipIdForGrid]).select('rect').attr('width', t.width).attr('height', t.height),
  ...
  n.prototype.axis.max = function (t) {
    ...
    'object' == typeof t ? (C(t.x) && (i.axis_x_max = t.x), C(t.y) && (i.axis_y_max = t.y), C(t.y2) && (i.axis_y2_max = t.y2)) : i.axis_y_max = i.axis_y2_max = t,
    e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })
  ...
  n.prototype.axis.min = function (t) {
    ...
    'object' == typeof t ? (C(t.x) && (i.axis_x_min = t.x), C(t.y) && (i.axis_y_min = t.y), C(t.y2) && (i.axis_y2_min = t.y2)) : i.axis_y_min = i.axis_y2_min = t,
    e.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })
  ...
  n.prototype.category = function (t, e) {
    var i = this.internal,
    n = i.config;
    return 1 < arguments.length && (n.axis_x_categories[t] = e, i.redraw()),
    n.axis_x_categories[t]
  },
  n.prototype.categories = function (t) {
    var e = this.internal,
    i = e.config;
    return arguments.length && (i.axis_x_categories = t, e.redraw()),
    i.axis_x_categories
  },
  ...
  n.prototype.flow = function (t) {
    ...
    c.data.targets.forEach(function (t) {
      for (var e, i = !1, n = 0; n < r.length; n++) if (t.id === r[n].id) {
        for (i = !0, t.values[t.values.length - 1] && (h = t.values[t.values.length - 1].index + 1), u = r[n].values.length, e = 0; e < u; e++) r[n].values[e].index = h + e,
    ...
    c.data.targets.length && r.forEach(function (t) {
      for (var e = [
      ], i = c.data.targets[0].values[0].index; i < h; i++) e.push({
        id: t.id,
        index: i,
    ...
    k(t.to) ? (u = 0, s = c.isTimeSeries() ? c.parseDate(t.to) : t.to, n.values.forEach(function (t) {
      t.x < s && u++
    })) : k(t.length) && (u = t.length),
    l ? 1 === l && c.isTimeSeries() && (o = (n.values[n.values.length - 1].x - a.x) / 2, i = [
      new Date(a.x - o),
      new Date( + a.x + o)
    ], c.updateXDomain(null, !0, !0, !1, i)) : (o = c.isTimeSeries() ? 1 < n.values.length ? n.values[n.values.length - 1].x - a.x : a.x - c.getXDomain(c.data.targets) [0] : 1, i = [
      a.x - o,
      a.x
  ...
  l.prototype.generateFlow = function (G) {
    ...
    return function () {
      ...
      t = 'translate(' + (u.orgDataCount ? 1 === u.orgDataCount || (b && b.x) === (T && T.x) || E.isTimeSeries() ? E.x(A[0]) - E.x(e[0]) : E.x(b.x) - E.x(T.x) : 1 !== E.data.targets[0].values.length ? E.x(A[0]) - E.x(e[0]) : E.isTimeSeries() ? (b = E.getValueOnIndex(E.data.targets[0].values, 0), T = E.getValueOnIndex(E.data.targets[0].values, E.data.targets[0].values.length - 1), E.x(b.x) - E.x(T.x)) : R(e) / 2) + ',0) scale(' + R(A) / R(e) + ',1)',
      E.hideXGridFocus();
      ...
      L(function () {
        ...
        if (v) {
          for (t = 0; t < v; t++) e.push('.' + Y.shape + '-' + (w + t)),
          i.push('.' + Y.text + '-' + (w + t));
  ...
  n.prototype.revert = function (t) {
    ...
    e.config.legend_show && (e.showLegend(t.filter(e.isLegendToShow.bind(e))), e.legend.selectAll(e.selectorLegends(t)).filter(function () {
  ...
  (n.prototype.xgrids = function (t) {
    var e = this.internal,
    i = e.config;
    return t && (i.grid_x_lines = t, e.redrawWithoutRescale()),
    i.grid_x_lines
  }).add = function (t) {
    var e = this.internal;
  ...
  (n.prototype.ygrids = function (t) {
    var e = this.internal,
    i = e.config;
    return t && (i.grid_y_lines = t, e.redrawWithoutRescale()),
    i.grid_y_lines
  }).add = function (t) {
    var e = this.internal;
  ...
  n.prototype.groups = function (t) {
    var e = this.internal,
    i = e.config;
    return w(t) || (i.data_groups = t, e.redraw()),
    i.data_groups
  },
  ...
  (n.prototype.regions = function (t) {
    var e = this.internal,
    i = e.config;
    return t && (i.regions = t, e.redrawWithoutRescale()),
    i.regions
  }).add = function (t) {
    var e = this.internal,
    i = e.config;
    return t && (i.regions = i.regions.concat(t), e.redrawWithoutRescale()),
    i.regions
  },
  ...
  n.prototype.zoom.max = function (t) {
    ...
    i.zoom_x_max = n.max([e.orgXDomain[1],
    t])
  },
  n.prototype.zoom.min = function (t) {
    ...
    i.zoom_x_min = n.min([e.orgXDomain[0],
    t])
  },
  ...
  l.prototype.transformForArcLabel = function (t) {
    ...
    l = '',
    u = s.hasType('gauge');
    return d && !u ? (e = this.svgArc.centroid(d), a = isNaN(e[0]) ? 0 : e[0], o = isNaN(e[1]) ? 0 : e[1], i = Math.sqrt(a * a + o * o), l = 'translate(' + a * (n = s.hasType('donut') && c.donut_label_ratio ? h(c.donut_label_ratio) ? c.donut_label_ratio(t, s.radius, i) : c.donut_label_ratio : s.hasType('pie') && c.pie_label_ratio ? h(c.pie_label_ratio) ? c.pie_label_ratio(t, s.radius, i) : c.pie_label_ratio : s.radius && i ? (0.375 < 36 / s.radius ? 1.175 - 36 / s.radius : 0.8) * s.radius / i : 0) + ',' + o * n + ')') : d && u && 1 < s.filterTargetsToShow(s.data.targets).length && (r = Math.sin(d.endAngle - Math.PI / 2), l = 'translate(' + (a = Math.cos(d.endAngle - Math.PI / 2) * (s.radiusExpanded + 25)) + ',' + (o = r * (s.radiusExpanded + 15 - Math.abs(10 * r)) + 3) + ')'),
    l
  },
  ...
  l.prototype.redrawArc = function (t, e, i) {
    ...
    d && (r = (n = c.selectAll('.' + Y.arcs).selectAll('.' + Y.arcLabelLine).data(l.arcData.bind(l))).enter().append('rect').attr('class', function (t) {
      ...
      c = 0,
      d = '';
      l.hiddenTargetIds.indexOf(t.data.id) < 0 && (e = l.updateAngle(t), i = l.gaugeArcWidth / l.filterTargetsToShow(l.data.targets).length * (e.index + 1), a = (n = e.endAngle - Math.PI / 2) - (0 == (r = l.radius - i) ? 0 : 1 / r), o = l.radiusExpanded - l.radius + i, s = Math.cos(a) * r, c = Math.sin(a) * r, d = 'rotate(' + 180 * n / Math.PI + ', ' + s + ', ' + c + ')'),
    ...
    d && (a = 0, (o = l.arcs.select('g.' + Y.chartArcsBackground).selectAll('path.' + Y.chartArcsBackground).data(l.data.targets)).enter().append('path').attr('class', function (t, e) {
  ...
  l.prototype.getCaches = function (t) {
    for (var e = [
    ], i = 0; i < t.length; i++) t[i] in this.cache && e.push(this.cloneTarget(this.cache[t[i]]));
    return e
  },
  ...
  l.prototype.generateColor = function () {
    ...
    return function (t) {
      ...
      return n[i] instanceof Function ? e = n[i](t) : n[i] ? e = n[i] : (o.indexOf(i) < 0 && o.push(i), e = r[o.indexOf(i) % r.length], n[i] = e),
  ...
  l.prototype.convertColumnsToData = function (t) {
    for (var e = [
      ...
      for (var r = t[n][0], a = 1; a < t[n].length; a++) {
        if (w(e[a - 1]) && (e[a - 1] = {
        }), w(t[n][a])) throw new Error('Source data is missing a component at (' + n + ',' + a + ')!');
        e[a - 1][r] = t[n][a]
      }
      i.push(r)
    }
  ...
  l.prototype.convertDataToTargets = function (t, n) {
    ...
    return i.forEach(function (i) {
      var e = l.getXKey(i);
      l.isCustomX() || l.isTimeSeries() ? 0 <= r.indexOf(e) ? l.data.xs[i] = (n && l.data.xs[i] ? l.data.xs[i] : [
    ...
    (e = i.map(function (o, s) {
      ...
      return {
        ...
        values: t.map(function (t, e) {
          ...
          ]), - 1 === (i = u.axis_x_categories.indexOf(r)) && (i = u.axis_x_categories.length, u.axis_x_categories.push(r))) : i = l.generateTargetX(r, o, e),
  ...
  l.prototype.getTotalDataSum = function () {
    ...
    var i,
    n = (i = e.data.targets.filter(function (t) {
      return e.isTargetToShow(t.id)
    }).map(function (t) {
      return t.values
    }), (Array.isArray(i) ? [
  ...
  l.prototype.mapToTargetIds = function (t) {
    return t ? [
    ].concat(t) : this.mapToIds(this.data.targets)
  },
  ...
  l.prototype.getDataLabelLength = function (t, e, i) {
    ...
    return n.selectChart.select('svg').selectAll('.dummy').data([t,
    e]).enter().append('text').text(function (t) {
  ...
  l.prototype.getRatio = function (t, e, i) {
    ...
    a = r.api,
    o = 0;
    return e && a.data.shown.call(a).length && (o = e.ratio || e.value, 'arc' === t ? o = r.hasType('gauge') ? (e.endAngle - e.startAngle) / (Math.PI * (r.config.gauge_fullCircle ? 2 : 1)) : (n = r.getTotalDataSum(), e.value / n) : 'index' === t && (n = r.getTotalPerIndex(r.axis.getId(e.id)), e.ratio = s(e.value) && n && 0 < n[e.index] ? e.value / n[e.index] : 0, o = e.ratio)),
    i && o ? 100 * o : o
  },
  ...
  l.prototype.getYDomain = function (t, e, i) {
    var n = this,
    r = n.config;
    if (n.isAxisNormalized(e)) return [0,
    100];
    var a,
    o,
    s,
    ...
    return 0 === x.length ? 'y2' === e ? n.y2.domain() : n.y.domain() : (isNaN(S) && (S = 0), isNaN(w) && (w = S), S === w && (S < 0 ? w = 0 : S = 0), g = 0 <= S && 0 <= w, p = S <= 0 && w <= 0, (C(y) && g || C(m) && p) && (b = !1), b && (g && (S = 0), p && (w = 0)), s = c = 0.1 * (o = Math.abs(w - S)), void 0 !== v && (w = v + (d = Math.max(Math.abs(S), Math.abs(w))), S = v - d), A ? (l = n.getDataLabelLength(S, w, 'width'), u = R(n.y.range()), s += o * ((h = [
      l[0] / u,
      l[1] / u
    ]) [1] / (1 - h[0] - h[1])), c += o * (h[0] / (1 - h[0] - h[1]))) : P && (l = n.getDataLabelLength(S, w, 'height'), s += (f = n.getY(r['axis_' + e + '_type'], [
      0,
      r.axis_rotated ? n.width : n.height
    ], [
      0,
      o
    ])) (l[1]), c += f(l[0])), 'y' === e && L(r.axis_y_padding) && (s = n.axis.getPadding(r.axis_y_padding, 'top', s, o), c = n.axis.getPadding(r.axis_y_padding, 'bottom', c, o)), 'y2' === e && L(r.axis_y2_padding) && (s = n.axis.getPadding(r.axis_y2_padding, 'top', s, o), c = n.axis.getPadding(r.axis_y2_padding, 'bottom', c, o)), b && (g && (c = S), p && (s = - w)), a = [
      S - c,
      w + s
    ], T ? a.reverse() : a)
  },
  ...
  l.prototype.getXDomainPadding = function (t) {
    ...
    r = this.config,
    a = t[1] - t[0],
    o = this.isCategorized() ? 0 : this.hasType('bar') ? 1 < (e = this.getMaxDataCount()) ? a / (e - 1) / 2 : 0.5 : 0.01 * a;
  ...
  l.prototype.getXDomain = function (t) {
    ...
    o = 0,
    s = 0;
    return n - r != 0 || e.isCategorized() || (r = e.isTimeSeries() ? (n = new Date(0.5 * n.getTime()), new Date(1.5 * r.getTime())) : (n = 0 === n ? 1 : 0.5 * n, 0 === r ? - 1 : 1.5 * r)),
  ...
  l.prototype.updateXDomain = function (t, e, i, n, r) {
    var a = this,
    o = a.config;
    return i && (a.x.domain(r || a.d3.extent(a.getXDomain(t))), a.orgXDomain = a.x.domain(), o.zoom_enabled && a.zoom.update(), a.subX.domain(a.x.domain()), a.brush && a.brush.updateScale(a.subX)),
  ...
  l.prototype.trimXDomain = function (t) {
    ...
    i = e[0],
    n = e[1];
    return t[0] <= i && (t[1] = + t[1] + (i - t[0]), t[0] = i),
  ...
  l.prototype.drag = function (t) {
    ...
    _.hasArcType() || x.data_selection_enabled && x.data_selection_multiple && (e = _.dragStart[0], i = _.dragStart[1], n = t[0], r = t[1], h = Math.min(e, n), g = Math.max(e, n), p = x.data_selection_grouped ? _.margin.top : Math.min(i, r), f = x.data_selection_grouped ? _.height : Math.max(i, r), a.select('.' + Y.dragarea).attr('x', h).attr('y', p).attr('width', g - h).attr('height', f - p), a.selectAll('.' + Y.shapes).selectAll('.' + Y.shape).each(function (t, e) {
      if (x.data_selection_isselectable(t)) {
        ...
        u = !1;
        if (c.classed(Y.circle)) i = + c.attr('cx'),
        n = + c.attr('cy'),
        o = _.togglePoint,
        u = h < i && i < g && p < n && n < f;
         else {
  ...
  l.prototype.dragstart = function (t) {
    var e = this,
    i = e.config;
    e.hasArcType() || i.data_selection_enabled && (e.dragStart = t, e.main.select('.' + Y.chart).append('rect').attr('class', Y.dragarea).style('opacity', 0.1), e.dragging = !0)
  },
  ...
  l.prototype.redrawGrid = function (t, e) {
    ...
    return [(t ? a.transition(e) : a).attr('x1', n.axis_rotated ? 0 : r).attr('x2', n.axis_rotated ? i.width : r).attr('y1', n.axis_rotated ? r : 0).attr('y2', n.axis_rotated ? r : i.height).style('opacity', 1),
    (t ? o.transition(e) : o).attr('x', n.axis_rotated ? i.yGridTextX.bind(i) : i.xGridTextX.bind(i)).attr('y', r).text(function (t) {
      return t.text
    }).style('opacity', 1)]
  },
  ...
  l.prototype.generateGridData = function (t, e) {
    ...
    if ('year' === t) for (n = (i = this.getXDomain()) [0].getFullYear(), r = i[1].getFullYear(), a = n; a <= r; a++) o.push(new Date(a + '-01-01 00:00:00'));
  ...
  l.prototype.redrawEventRect = function () {
    ...
    function h(t) {
      return t ? s.addName(Object.assign({
      }, t)) : null
    }
    ...
    s.eventRect.attr('x', 0).attr('y', 0).attr('width', s.width).attr('height', s.height).on('mouseout', d.interaction_enabled ? function () {
     ...
     : null).on('mousemove', d.interaction_enabled ? function () {
      if (!s.dragging) {
        ...
        if (!s.hasArcType(t)) {
          ...
          o = u(r, a);
          if (!s.mouseover || a && a.id === s.mouseover.id && a.index === s.mouseover.index || (d.data_onmouseout.call(s.api, s.mouseover), s.mouseover = void 0), a && !s.mouseover && (d.data_onmouseover.call(s.api, a), s.mouseover = a), s.svg.select('.' + Y.eventRect).style('cursor', o ? 'pointer' : null), !d.tooltip_grouped || s.hasType('stanford', t) ? a && (e = [
            a
          ]) : (n = void 0, (n = a || (i = d.axis_rotated ? r[1] : r[0], s.findClosestFromTargetsByX(t, s.x.invert(i)))) && (e = s.filterByX(t, n.x))), !e || 0 === e.length) return l();
          e = e.map(h),
          s.showTooltip(e, this),
          d.point_focus_expand_enabled && (s.unexpandCircles(), e.forEach(function (t) {
     ...
     : null).on('click', d.interaction_enabled ? function () {
      ...
      s.hasArcType(n) || (t = c.mouse(this), e = h(s.findClosestFromTargets(n, t)), u(t, e) && ((!d.data_selection_grouped || s.isStanfordType(e) ? [
        e
      ] : s.filterByX(n, e.x)).forEach(function (t) {
  ...
  l.prototype.initLegend = function () {
    ...
    }, t.legendHasRendered = !1, t.legend = t.svg.append('g').attr('transform', t.getTranslate('legend')), !t.config.legend_show) return t.legend.style('visibility', 'hidden'),
  ...
  l.prototype.updateLegend = function (f, t, e) {
    ...
    function R(t, e, i) {
      ...
      s && (T = b = I = C = 0),
      !S.legend_show || m.isLegendToShow(e) ? (V[e] = l, G[e] = u, (!b || b <= l) && (b = l), (!T || T <= u) && (T = u), r = m.isLegendRight || m.isLegendInset ? T : b, S.legend_equally ? (Object.keys(V).forEach(function (t) {
        V[t] = b
    ...
    m.isLegendInset && (I = S.legend_inset_step ? S.legend_inset_step : f.length, m.updateLegendStep(I)),
  ...
  l.prototype.getScale = function (t, e, i) {
    return (i ? this.d3.scaleTime() : this.d3.scaleLinear()).range([t,
    e])
  },
  l.prototype.getX = function (t, e, i, n) {
    ...
    this.isCategorized() && (a.domain = function (t) {
      return arguments.length ? (o.domain(t), a) : [
        (t = this.orgDomain()) [0],
        t[1] + 1
      ]
    }),
  ...
  l.prototype.updateScales = function () {
    ...
    e.subY = e.getY(t.axis_y_type, i ? t.axis_y_default : e.subY.domain(), [
      e.subYMin,
      e.subYMax
    ]),
    e.subY2 = e.getY(t.axis_y2_type, i ? t.axis_y2_default : e.subY2.domain(), [
      e.subYMin,
      e.subYMax
    ]),
  ...
  l.prototype.lineWithRegions = function (t, d, l, e) {
    ...
    if (k(e)) for (i = 0; i < e.length; i++) m[i] = {
    },
    ...
    for (g = _.axis_rotated ? function (t) {
     ...
     : function (t, e, i, n) {
      ...
      if (w(m) || !function (t, e) {
       ...
       else for (a = f.getScale(t[i - 1].x + y, t[i].x + y, f.isTimeSeries()), u = f.getScale(t[i - 1].value, t[i].value), o = d(t[i].x) - d(t[i - 1].x), s = l(t[i].value) - l(t[i - 1].value), h = 2 * (c = 2 / Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))), n = c; n <= 1; n += h) x += r(t[i - 1], t[i], n, c);
      t[i].x
    }
    return x
  },
  ...
  l.prototype.redrawCircle = function (t, e, i, n) {
    ...
    return [(i ? r.mainCircle.transition(n) : r.mainCircle).style('opacity', this.opacityForCircle.bind(r)).style('color', r.isStanfordGraphType() ? r.getStanfordPointColor.bind(r) : r.color).attr('cx', t).attr('cy', e),
  ...
  l.prototype.initBrush = function (t) {
    ...
    r.brush.selectionAsValue = function (t, e) {
      var i,
      n;
      return t ? (r.context && (i = [
        this.scale(t[0]),
        this.scale(t[1])
      ], n = r.context.select('.' + Y.brush), e && (n = n.transition()), r.brush.move(n, i)), [
      ]) : (i = r.brush.selection() || [
        0,
        0
      ], [
        this.scale.invert(i[0]),
        this.scale.invert(i[1])
      ])
    },
  ...
  l.prototype.redrawSubchart = function (t, e, i, n, r, a, o) {
    ...
    t && (l.brush.empty() || l.brush.selectionAsValue(l.x.orgDomain()), s = l.generateDrawArea(r, !0), c = l.generateDrawBar(a, !0), d = l.generateDrawLine(o, !0), l.updateBarForSubchart(i), l.updateLineForSubchart(i), l.updateAreaForSubchart(i), l.redrawBarForSubchart(c, i, i), l.redrawLineForSubchart(d, i, i), l.redrawAreaForSubchart(s, i, i))
  },
  ...
  l.prototype.getYForText = function (t, e, i) {
    ...
    r = this,
    a = d(i);
    return r.config.axis_rotated ? n = (t[0][0] + t[2][0] + 0.6 * a.height) / 2 : (n = t[2][1], e.value < 0 || 0 === e.value && !r.hasPositiveValue ? (n += a.height, r.isBarType(e) && r.isSafari() ? n -= 3 : !r.isBarType(e) && r.isChrome() && (n += 3)) : n += r.isBarType(e) ? - 3 : - 6),
  ...
  l.prototype.drawColorScale = function () {
    ...
    r = s.scaleSequential(d.colors).domain([e[e.length - 1],
    e[0]]),
    ...
    n = s.scaleLog().domain([d.minEpochs,
    d.maxEpochs]).range([e[0] + c.stanford_padding.top + e[e.length - 1] + 5 - 1,
    e[0] + c.stanford_padding.top]),
    i = s.axisRight(n),
    'pow10' === c.stanford_scaleFormat ? i.tickValues([1,
    10,
    100,
    1000,
    10000,
    100000,
    1000000,
    10000000]) : h(c.stanford_scaleFormat) ? i.tickFormat(c.stanford_scaleFormat) : i.tickFormat(s.format('d')),
  ...
  l.prototype.initStanfordData = function () {
    ...
    a.colors = h(r.stanford_colors) ? r.stanford_colors : n.interpolateHslLong(n.hsl(250, 1, 0.5), n.hsl(0, 1, 0.5)),
    a.colorscale = n.scaleSequentialLog(a.colors).domain([i,
    e]),
    a.minEpochs = i,
    a.maxEpochs = e
  },
  ...
  l.prototype.getCentroid = function (t) {
    for (var e, i, n, r = y(t), a = 0, o = 0, s = 0, c = t.length - 1; s < t.length; c = s, s += 1) i = t[s],
    n = t[c],
    e = i.x * n.y - n.x * i.y,
    a += (i.x + n.x) * e,
    o += (i.y + n.y) * e;
  ...
  var y = function (t) {
    for (var e, i, n = 0, r = 0, a = t.length - 1; r < t.length; a = r, r += 1) e = t[r],
    i = t[a],
    n += e.x * i.y,
    n -= e.y * i.x;
    return n /= 2
  ...
  S = function (t, e) {
    for (var i, n, r, a, o = t.x, s = t.value, c = !1, d = 0, l = e.length - 1; d < e.length; l = d++) i = e[d].x,
    n = e[d].y,
    a = e[l].x,
  ...
  l.prototype.updateStanfordElements = function (t) {
    ...
    (i = (e = o.select('.' + Y.stanfordRegions).selectAll('.' + Y.stanfordRegion).data(s.stanford_regions)).enter().append('g').attr('class', function (t) {
      ...
      return t.points.map(function (t) {
        return [s.axis_rotated ? d(t, 'y') : c(t, 'x'),
        s.axis_rotated ? c(t, 'x') : d(t, 'y')].join(',')
      }).join(' ')
    }).style('opacity', 0),
  ...
  l.prototype.getTooltipContent = function (t, e, i, n) {
    ...
    for (f && t.sort(f), a = 0; a < t.length; a++) if (t[a] && (t[a].value || 0 === t[a].value)) {
      if (l.isStanfordGraphType()) r || (o = l.getStanfordTooltipTitle(t[a]), r = '<table class=\'' + l.CLASS.tooltip + '\'>' + o),
  ...
  l.prototype.isLineType = function (t) {
    var e = this.config,
    i = g(t) ? t : t.id;
    return !e.data_types[i] || 0 <= ['line',
    'spline',
    'area',
    'area-spline',
    'step',
    'area-step'].indexOf(e.data_types[i])
  },
  l.prototype.isStepType = function (t) {
    var e = g(t) ? t : t.id;
    return 0 <= ['step',
    'area-step'].indexOf(this.config.data_types[e])
  },
  l.prototype.isSplineType = function (t) {
    var e = g(t) ? t : t.id;
    return 0 <= ['spline',
    'area-spline'].indexOf(this.config.data_types[e])
  },
  ...
  l.prototype.initZoom = function () {
    ...
    i.zoom.updateExtent = function () {
      return this.scaleExtent([1,
      1 / 0]).translateExtent([[0,
      0],
      [
        i.width,
        i.height
  ...
  l.prototype.getZoomDomain = function () {
    var t = this.config,
    e = this.d3;
    return [e.min([this.orgXDomain[0],
    t.zoom_x_min]),
    e.max([this.orgXDomain[1],
    t.zoom_x_max])]
  },
  l.prototype.redrawForZoom = function () {
    ...
    n = t.zoom,
    r = t.x;
    i.zoom_enabled && 0 !== t.filterTargetsToShow(t.data.targets).length && (n.update(), i.zoom_disableDefaultBehavior || (t.isCategorized() && r.orgDomain() [0] === t.orgXDomain[0] && r.domain([t.orgXDomain[0] - 1e-10,
    r.orgDomain() [1]]), t.redraw({
      withTransition: !1,
