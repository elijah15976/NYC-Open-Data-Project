...
!function (t, n) {
  ...
  function B(t, n) {
    ...
    function l(l) {
      ...
      l !== b && (m = m.transition(l), x = x.transition(l), N = N.transition(l), A = A.transition(l), w = w.transition(l).attr('opacity', L).attr('transform', function (t) {
    ...
    l.tickArguments = function (t) {
      return arguments.length ? (e = null == t ? [
      ] : C.call(t), l) : e.slice()
    },
  ...
  function zt(t) {
    return 'string' == typeof t ? new Ct([[document.querySelector(t)]], [
  ...
  Ct.prototype = Pt.prototype = {
    ...
    selectAll: function (t) {
      ...
      ], o = 0; o < e; ++o) for (var a, u = n[o], c = u.length, f = 0; f < c; ++f) (a = u[f]) && (r.push(t.call(a, a.__data__, f, u)), i.push(a));
      return new Ct(r, i)
    },
    filter: function (t) {
      'function' != typeof t && (t = tt(t));
      for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i) for (var o, a = n[i], u = a.length, c = r[i] = [
      ], f = 0; f < u; ++f) (o = a[f]) && t.call(o, o.__data__, f, a) && c.push(o);
      return new Ct(r, this._parents)
    },
    data: function (t, n) {
  ...
  en = /^#([0-9a-f]{3})$/,
  rn = /^#([0-9a-f]{6})$/,
  on = new RegExp('^rgb\\(' + [Kt,
  Kt,
  Kt] + '\\)$'),
  an = new RegExp('^rgb\\(' + [nn,
  nn,
  nn] + '\\)$'),
  un = new RegExp('^rgba\\(' + [Kt,
  Kt,
  Kt,
  tn] + '\\)$'),
  cn = new RegExp('^rgba\\(' + [nn,
  nn,
  nn,
  tn] + '\\)$'),
  fn = new RegExp('^hsl\\(' + [tn,
  nn,
  nn] + '\\)$'),
  sn = new RegExp('^hsla\\(' + [tn,
  nn,
  nn,
  tn] + '\\)$'),
  ln = {
  ...
  function mn(t, n, e, r) {
    return 1 === arguments.length ? function (t) {
      ...
      u = o - i,
      c = (o + i) / 2;
      return u ? (a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4, u /= c < 0.5 ? o + i : 2 - o - i, a *= 60) : u = c > 0 && c < 1 ? 0 : a,
  ...
  function zn(t) {
    ...
    return i === o && o === a ? e = r = u : (e = Dn((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / An), r = Dn((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / kn)),
  ...
  Zt(qn, Rn, Qt(Jt, {
    ...
    rgb: function () {
      ...
      return new yn(Un(3.1338561 * (n = An * Ln(n)) - 1.6168667 * (t = Sn * Ln(t)) - 0.4906146 * (e = kn * Ln(e))), Un( - 0.9787684 * n + 1.9161415 * t + 0.033454 * e), Un(0.0719453 * n - 0.2289914 * t + 1.4052427 * e), this.opacity)
    }
  })),
  Zt(Fn, Bn, Qt(Jt, {
    brighter: function (t) {
  ...
  function de(t, n) {
    ...
    }), n) e in t ? r[e] = ye(t[e], n[e]) : i[e] = n[e];
    return function (t) {
  ...
  function ge(t, n) {
    ...
    for (t += '', n += ''; (e = pe.exec(t)) && (r = ve.exec(n)); ) (i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i),
  ...
  function or() {
    nr(),
    ++Ge;
    for (var t, n = je; n; ) (t = Qe - n._time) >= 0 && n._call.call(null, t),
    n = n._next;
    --Ge
  }
  function ar() {
  ...
  rr.prototype = ir.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      this._next || Xe === this || (Xe ? Xe._next = this : je = this, Xe = this),
      this._call = t,
      this._time = e,
      cr()
    },
  ...
  Er.prototype = Cr.prototype = {
    ...
    selectAll: function (t) {
      ...
      ], u = 0; u < i; ++u) for (var c, f = r[u], s = f.length, l = 0; l < s; ++l) if (c = f[l]) {
    ...
    style: function (t, n, e) {
      ...
      return null == n ? this.styleTween(t, function (t, n) {
        ...
        return function () {
          ...
          u = e(this),
          c = u + '';
          return null == u && (this.style.removeProperty(t), c = u = ct(this, t)),
  ...
  function ci(t, n) {
    for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return ui.time = nr(),
    ui;
    return e
  }
  ...
  function Pi(n) {
    ...
    function u(t) {
      ...
      t.selectAll('.selection').data([Si('selection')]).enter().append('rect').attr('class', 'selection').attr('cursor', xi.selection).attr('fill', '#777').attr('fill-opacity', 0.3).attr('stroke', '#fff').attr('shape-rendering', 'crispEdges');
    ...
    function l() {
          ...
          var U = zt(t.event.view).on('keydown.brush', function () {
            ...
            switch (t.event.keyCode) {
              ...
              case 18:
                ...
                break;
              case 32:
                x === vi && (t.event.altKey ? (w && (s = l - p * w, r = o + p * w), M && (h = d - v * M, a = u + v * M), x = yi) : (w < 0 ? s = l : w > 0 && (r = o), M < 0 ? h = d : M > 0 && (a = u), x = gi), L.attr('cursor', xi[m]), Y());
                break;
              default:
                return
            }
      ...
      function Y() {
        ...
        y && (o = S[0][0], l = S[1][0]),
        _ && (u = S[0][1], d = S[1][1]),
        S[0][0] === o && S[0][1] === u && S[1][0] === l && S[1][1] === d || (N.selection = [
          [o,
          u],
          [
            l,
    ...
    u.extent = function (t) {
      return arguments.length ? (r = 'function' == typeof t ? t : si([[ + t[0][0],
      + t[0][1]],
      [
        + t[1][0],
        + t[1][1]
  ...
  Hi.prototype = ji.prototype = {
    ...
    arcTo: function (t, n, e, r, i) {
      ...
      if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
       else if (l > 0.000001) if (Math.abs(s * u - c * f) > 0.000001 && i) {
        var h = e - o,
        d = r - a,
        p = u * u + c * c,
        v = h * h + d * d,
        ...
        b = _ / y,
        m = _ / g;
        Math.abs(b - 1) > 0.000001 && (this._ += 'L' + (t + b * f) + ',' + (n + b * s)),
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      null === this._x1 ? this._ += 'M' + c + ',' + f : (Math.abs(this._x1 - c) > 0.000001 || Math.abs(this._y1 - f) > 0.000001) && (this._ += 'L' + c + ',' + f),
      e && (l < 0 && (l = l % Fi + Fi), l > Ii ? this._ += 'A' + e + ',' + e + ',0,1,' + s + ',' + (t - a) + ',' + (n - u) + 'A' + e + ',' + e + ',0,1,' + s + ',' + (this._x1 = c) + ',' + (this._y1 = f) : l > 0.000001 && (this._ += 'A' + e + ',' + e + ',0,' + + (l >= Bi) + ',' + s + ',' + (this._x1 = t + e * Math.cos(i)) + ',' + (this._y1 = n + e * Math.sin(i))))
    },
  ...
  function po() {
    ...
    function o(e, i) {
      ...
      return function (e, r, i) {
        ...
        ho[f << 0].forEach(p);
        for (; ++u < n - 1; ) {
          for (o = - 1, f = e[u * t + t] >= r, s = e[u * t] >= r, ho[f << 1 | s << 2].forEach(p); ++o < t - 1; ) c = f,
          f = e[u * t + t + o + 1] >= r,
          l = s,
          s = e[u * t + o + 1] >= r,
    ...
    function r(t, n) {
      ...
      function s() {
        ...
        if (t.charCodeAt(i) === wo) {
          ...
          return (n = a) >= o ? c = !0 : (r = t.charCodeAt(a++)) === Mo ? f = !0 : r === No && (f = !0, t.charCodeAt(a) === Mo && ++a),
  ...
  function Qo(t, n, e, r) {
    ...
    t;
    for (; d.length; ) if ((f = n >= (o = (v + y) / 2)) ? v = o : y = o, (s = e >= (a = (g + _) / 2)) ? g = a : _ = a, i = d, !(d = d[l = s << 1 | f])) return i[l] = p,
    t;
  ...
  ia.copy = function () {
    ...
    r = this._root;
    if (!r) return e;
    if (!r.length) return e._root = ra(r),
    e;
    for (t = [
      {
        source: r,
  ...
  ia.find = function (t, n, e) {
    ...
    v = this._root;
    for (v && p.push(new Jo(v, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop(); ) if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (v.length) {
      var g = (i + a) / 2,
      y = (o + u) / 2;
  ...
  ia.visit = function (t) {
    ...
    c = this._root;
    for (c && u.push(new Jo(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop(); ) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
      var f = (r + o) / 2,
      s = (i + a) / 2;
  ...
  function Na(t) {
    ...
    r = t.grouping && t.thousands ? (n = t.grouping, e = t.thousands, function (t, r) {
      ...
      ], a = 0, u = n[0], c = 0; i > 0 && u > 0 && (c + u + 1 > r && (u = Math.max(1, r - c)), o.push(t.substring(i -= u, i + u)), !((c += u + 1) > r)); ) u = n[a = (a + 1) % n.length];
    ...
    function c(t) {
      ...
      function m(t) {
        ...
        t = '';
          ...
          }(t)), w && 0 == + t && (w = !1), m = (w ? '(' === c ? c : '-' : '-' === c || '(' === c ? '' : c) + m, x = ('s' === v ? Ma[8 + va / 3] : '') + x + (w && '(' === c ? ')' : ''), b) for (i = - 1, u = t.length; ++i < u; ) if (48 > (f = t.charCodeAt(i)) || f > 57) {
  ...
  nc = {
    ...
    polygonEnd: function () {
      ...
      nc.lineStart = ic,
      nc.lineEnd = oc,
      pu < 0 ? (Tu = - (Cu = 180), Eu = - (Pu = 90)) : tc > Ra ? Pu = 90 : tc < - Ra && (Eu = - 90),
      Uu[0] = Tu,
      Uu[1] = Cu
    }
  };
  ...
  function Ac(t, n) {
    return [Fa(t) > Da ? t + Math.round( - t / Oa) * Oa : t,
    n]
  }
  function Sc(t, n, e) {
  ...
  function kc(t) {
    return function (n, e) {
      return [(n += t) > Da ? n - Oa : n < - Da ? n + Oa : n,
      e]
    }
  }
  function Tc(t) {
  ...
  function Pc(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var f, s = i; r > 0 ? s > o : s < o; s -= c) f = xu([a,
      - u * ja(s),
      - u * Wa(s)]),
      t.point(f[0], f[1])
    }
    ...
    if (t.forEach(function (t) {
      if (!((n = t.length - 1) <= 0)) {
        ...
        if (qc(r, a)) {
          ...
          i.lineEnd()
        } else u.push(e = new Dc(r, t, null, !0)),
  ...
  function Yc(t, n) {
    ...
    for (var c = 0, f = t.length; c < f; ++c) if (l = (s = t[c]).length) for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Ua, v = Wa(p), g = ja(p), y = 0; y < l; ++y, d = b, v = x, g = w, h = _) {
      var _ = s[y],
      b = _[0],
      m = _[1] / 2 + Ua,
      x = Wa(m),
    ...
    return function (i) {
      ...
      h = {
        ...
        polygonEnd: function () {
          ...
          a = S(a);
          var t = Yc(o, r);
          a.length ? (l || (i.polygonStart(), l = !0), Lc(a, Ic, t, e, i)) : t && (l || (i.polygonStart(), l = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
          l && (i.polygonEnd(), l = !1),
          a = o = null
        },
        sphere: function () {
  ...
  var Hc = Bc(function () {
    ...
    return {
      ...
      point: function (o, a) {
        var u = o > 0 ? Da : - Da,
        c = Fa(o - e);
        Fa(c - Da) < Ra ? (t.point(e, r = (r + a) / 2 > 0 ? La : - La), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && c >= Da && (Fa(e - i) < Ra && (e -= i * Ra), Fa(o - u) < Ra && (o -= u * Ra), r = function (t, n, e, r) {
          var i,
          o,
          a = Wa(t - e);
    ...
    return Bc(o, function (t) {
      ...
      return {
        ...
        point: function (l, h) {
          ...
          if (!n && (f = c = v) && t.lineStart(), v !== c && (!(d = a(n, p)) || qc(n, d) || qc(p, d)) && (p[0] += Ra, p[1] += Ra, v = o(p[0], p[1])), v !== c) s = 0,
  ...
  function Es(t) {
    ...
    A.clipExtent = function (t) {
      return arguments.length ? (M = null == t ? (w = r = i = o = null, _f) : Vc(w = + t[0][0], r = + t[0][1], i = + t[1][0], o = + t[1][1]), T()) : null == w ? null : [
        [w,
        r],
        [
          i,
    ...
    A.translate = function (t) {
      return arguments.length ? (h = + t[0], d = + t[1], k()) : [
        h,
        d
      ]
    },
    A.center = function (t) {
      return arguments.length ? (p = t[0] % 360 * Ba, v = t[1] % 360 * Ba, k()) : [
        p * Ya,
        v * Ya
      ]
    },
    A.rotate = function (t) {
      return arguments.length ? (g = t[0] % 360 * Ba, y = t[1] % 360 * Ba, _ = t.length > 2 ? t[2] % 360 * Ba : 0, k()) : [
        g * Ya,
        y * Ya,
        _ * Ya
      ]
  ...
  function Cs(t) {
    ...
    return i.parallels = function (t) {
      return arguments.length ? r(n = t[0] * Ba, e = t[1] * Ba) : [
        n * Ya,
        e * Ya
      ]
    },
  ...
  function Ps(t, n) {
    ...
    return a.invert = function (t, n) {
      var e = o - n;
      return [Ha(t, Fa(e)) / r * Za(e),
      tu((i - (t * t + e * e) * r * r) / (2 * r))]
    },
    a
  }
  function zs() {
    return Cs(Ps).scale(155.424).center([0,
    33.6442])
  }
  function Rs() {
    return zs().parallels([29.5,
  ...
  function Ws(t, n) {
    ...
    r = e * e,
    i = r * r * r;
    return [t * ja(e) / ($s * (js + 3 * Xs * r + i * (7 * Gs + 9 * Vs * r))),
    e * (js + Xs * r + i * (Gs + Vs * r))]
  }
  function Zs(t, n) {
    var e = ja(n),
  ...
  function al(t, n) {
    ...
    for (null == n && (n = ul); e = f.pop(); ) if (c && (e.value = + e.data.value), (i = n(e.data)) && (a = i.length)) for (e.children = new Array(a), o = a - 1; o >= 0; --o) f.push(r = e.children[o] = new sl(i[o])),
    r.parent = e,
    r.depth = e.depth + 1;
  ...
  Ws.invert = function (t, n) {
    ...
    return [$s * t * (js + 3 * Xs * i + o * (7 * Gs + 9 * Vs * i)) / ja(r),
    tu(Wa(r) / $s)]
  },
  Zs.invert = Ds(Ia),
  ...
  sl.prototype = al.prototype = {
    ...
    each: function (t) {
      ...
      do {
        for (n = a.reverse(), a = [
        ]; o = n.pop(); ) if (t(o), e = o.children) for (r = 0, i = e.length; r < i; ++r) a.push(e[r])
      } while (a.length);
      return this
    },
    eachAfter: function (t) {
      ...
      ]; i = o.pop(); ) if (a.push(i), n = i.children) for (e = 0, r = n.length; e < r; ++e) o.push(n[e]);
      for (; i = a.pop(); ) t(i);
      return this
    },
  ...
  function dl(t, n) {
    ...
    r;
    if (gl(n, t)) return [n];
    for (e = 0; e < t.length; ++e) if (pl(n, t[e]) && gl(_l(t[e], n), t)) return [t[e],
    n];
    for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (pl(_l(t[e], t[r]), n) && pl(_l(t[e], n), t[r]) && pl(_l(t[r], n), t[e]) && gl(bl(t[e], t[r], n), t)) return [t[e],
    t[r],
    n];
    throw new Error
  }
  ...
  function Nl(t) {
    ...
    for (r = hl(n), u = 0; u < i; ++u) (n = t[u]).x -= r.x,
    n.y -= r.y;
    return r.r
  }
  function Al(t) {
  ...
  function Vl(t, n, e, r, i, o) {
    for (var a, u, c, f, s, l, h, d, p, v, g, y = [
    ], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
      c = i - e,
      f = o - r;
      do {
        s = _[m++].value
  ...
  var Wl = function t(n) {
    function e(t, e, r, i, o) {
      if ((a = t._squarify) && a.ratio === n) for (var a, u, c, f, s, l = - 1, h = a.length, d = t.value; ++l < h; ) {
        ...
        d -= u.value
      } else t._squarify = a = Vl(n, t, e, r, i, o),
      a.ratio = n
    }
    return e.ratio = function (n) {
      return t((n = + n) > 1 ? n : 1)
  ...
  function _h(t, n, e) {
    ...
    o = n[0],
    a = n[1];
    return i < r ? (r = gh(i, r), o = e(a, o)) : (r = gh(r, i), o = e(o, a)),
    function (t) {
      return o(r(t))
    }
  }
  function bh(t, n, e) {
    ...
    a = new Array(r),
    u = - 1;
    for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++u < r; ) o[u] = gh(t[u], t[u + 1]),
    a[u] = e(n[u], n[u + 1]);
    return function (n) {
      var e = i(t, n, 1, r) - 1;
      return a[e](o[e](n))
  ...
  Wh = $h.range,
  Zh = Hh(function (t) {
    t.setTime(t - t.getMilliseconds() - 1000 * t.getSeconds())
  }, function (t, n) {
    t.setTime( + t + n * Gh)
  }, function (t, n) {
    return (n - t) / Gh
  ...
  Qh = Zh.range,
  Jh = Hh(function (t) {
    t.setTime(t - t.getMilliseconds() - 1000 * t.getSeconds() - t.getMinutes() * Gh)
  }, function (t, n) {
  ...
  td = Hh(function (t) {
    ...
    return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Gh) / 86400000
  }, function (t) {
    return t.getDate() - 1
  }),
  nd = td.range;
  ...
  function Wd(t) {
    ...
    function w(t, n) {
      return function (e) {
        ...
        c = 0,
        f = t.length;
        for (e instanceof Date || (e = new Date( + e)); ++u < f; ) 37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = Qd[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = 'e' === r ? ' ' : '0', (o = n[r]) && (r = o(e, i)), a.push(r), c = u + 1);
    ...
    function M(t, n) {
      return function (e) {
        ...
        if ('p' in o && (o.H = o.H % 12 + 12 * o.p), 'V' in o) {
          ...
          'w' in o || (o.w = 1),
          'Z' in o ? (i = (r = Vd($d(o.y))).getUTCDay(), r = i > 4 || 0 === i ? Ed.ceil(r) : Ed(r), r = Ad.offset(r, 7 * (o.V - 1)), o.y = r.getUTCFullYear(), o.m = r.getUTCMonth(), o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = n($d(o.y))).getDay(), r = i > 4 || 0 === i ? id.ceil(r) : id(r), r = td.offset(r, 7 * (o.V - 1)), o.y = r.getFullYear(), o.m = r.getMonth(), o.d = r.getDate() + (o.w + 6) % 7)
  ...
  function Yp(t, n) {
    return np(t.getFullYear() % 10000, n, 4)
  }
  function Bp(t) {
  ...
  function ev(t, n) {
    return np(t.getUTCFullYear() % 10000, n, 4)
  }
  function rv() {
    return '+0000'
  }
  ...
  function Mv() {
    ...
    return h.domain = function (a) {
      return arguments.length ? (t = o(u = + a[0]), n = o(c = + a[1]), e = o(f = + a[2]), r = t === n ? 0 : 0.5 / (n - t), i = n === e ? 0 : 0.5 / (e - n), h) : [
        u,
        c,
        f
      ]
  ...
  function hy(t, n, e, r, i, o, a) {
    ...
    C = S - g,
    P = k - y;
    return T * T + E * E > C * C + P * P && (N = S, A = k),
    {
      cx: N,
      cy: A,
      x01: - s,
  ...
  function yy() {
    ...
    function a(a) {
      ...
      s = a.length,
      l = !1;
      for (null == r && (o = i(f = ji())), u = 0; u <= s; ++u) !(u < s && e(c = a[u], u, a)) === l && ((l = !l) ? o.lineStart() : o.lineEnd()),
  ...
  function Py(t) {
    ...
    function a() {
      ...
      c = n.apply(this, u),
      f = e.apply(this, u);
      if (o || (o = a = ji()), t(o, + r.apply(this, (u[0] = c, u)), + i.apply(this, u), + r.apply(this, (u[0] = f, u)), + i.apply(this, u)), a) return o = null,
      a + '' || null
    }
  ...
  B_.prototype = {
    ...
    insert: function (t, n) {
      ...
      for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; ) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (I_(this, e), e = (t = e).U), e.C = !1, r.C = !0, H_(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (H_(this, e), e = (t = e).U), e.C = !1, r.C = !0, I_(this, r)),
      e = t.U;
      this._.C = !1
    },
    remove: function (t) {
      ...
      o = t.L,
      a = t.R;
      if (e = o ? a ? j_(a) : o : a, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && a ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== a ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = a, a.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1;
       else {
        do {
          if (t === this._) break;
          if (t === i.L) {
            if ((n = i.R).C && (n.C = !1, i.C = !0, I_(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
              n.R && n.R.C || (n.L.C = !1, n.C = !0, H_(this, n), n = i.R),
              n.C = i.C,
              i.C = n.R.C = !1,
              I_(this, i),
              t = this._;
            ...
            n.L && n.L.C || (n.R.C = !1, n.C = !0, I_(this, n), n = i.L),
            n.C = i.C,
            i.C = n.L.C = !1,
            H_(this, i),
            t = this._;
    ...
    if (n && e) {
      ...
      if (r !== o) {
        ...
        if (!(h >= - yb)) {
          ...
          t.circle = y;
          for (var _ = null, b = pb._; b; ) if (y.y < b.y || y.y === b.y && y.x <= b.x) {
            if (!b.L) {
              _ = b.P;
              break
            }
  ...
  function cb(t) {
    ...
    ub(t);
    for (var c = o; c.circle && Math.abs(e - c.circle.x) < gb && Math.abs(r - c.circle.cy) < gb; ) o = c.P,
    u.unshift(c),
    ub(c),
    c = o;
    u.unshift(c),
    rb(c);
    for (var f = a; f.circle && Math.abs(e - f.circle.x) < gb && Math.abs(r - f.circle.cy) < gb; ) a = f.N,
    u.push(f),
    ub(f),
    f = a;
    u.push(f),
  ...
  function fb(t) {
    for (var n, e, r, i, o = t[0], a = t[1], u = hb._; u; ) if ((r = sb(u, a) - o) > gb) u = u.L;
     else {
      if (!((i = o - lb(u, a)) > gb)) {
  ...
  function bb(t, n) {
    ...
    o = t.sort(_b).pop();
    for (vb = [
    ], db = new Array(t.length), hb = new B_, pb = new B_; ; ) if (i = K_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (fb(o), e = o[0], r = o[1]),
    o = t.pop();
     else {
      if (!i) break;
      cb(i.arc)
    ...
    if (function () {
      for (var t, n, e, r, i = 0, o = db.length; i < o; ++i) if ((t = db[i]) && (r = (n = t.halfedges).length)) {
        var a = new Array(r),
        u = new Array(r);
        for (e = 0; e < r; ++e) a[e] = e,
        u[e] = Z_(t, vb[n[e]]);
      ...
      function (t, n, e, r) {
        ...
        g = db.length,
        y = !0;
        for (i = 0; i < g; ++i) if (o = db[i]) {
          for (a = o.site, u = (c = o.halfedges).length; u--; ) vb[c[u]] || c.splice(u, 1);
          for (u = 0, f = c.length; u < f; ) p = (d = J_(o, vb[c[u]])) [0],
          v = d[1],
          l = (s = Q_(o, vb[c[++u % f]])) [0],
          h = s[1],
          (Math.abs(p - l) > gb || Math.abs(v - h) > gb) && (c.splice(u, 0, vb.push(G_(a, d, Math.abs(p - t) < gb && r - v > gb ? [
            t,
            Math.abs(l - t) < gb ? h : r
  ...
  bb.prototype = {
    ...
    triangles: function () {
      ...
      return this.cells.forEach(function (e, r) {
        if (o = (i = e.halfedges).length) for (var i, o, a, u, c, f, s = e.site, l = - 1, h = n[i[o - 1]], d = h.left === s ? h.right : h.left; ++l < o; ) a = d,
        d = (h = n[i[l]]).left === s ? h.right : h.left,
        a && d && r < a.index && r < d.index && (c = a, f = d, ((u = s) [0] - f[0]) * (c[1] - u[1]) - (u[0] - c[0]) * (f[1] - u[1]) < 0) && t.push([s.data,
        a.data,
        d.data])
      }),
      t
  ...
  t.ribbon = function () {
    ...
    function a() {
      ...
      g = r.apply(this, u) - Di,
      y = i.apply(this, u) - Di;
      if (o || (o = a = ji()), o.moveTo(d, p), o.arc(0, 0, s, l, h), l === g && h === y || (o.quadraticCurveTo(0, 0, v * zi(g), v * Ri(g)), o.arc(0, 0, v, g, y)), o.quadraticCurveTo(0, 0, d, p), o.closePath(), a) return o = null,
      a + '' || null
    }
  ...
  t.drag = function () {
    ...
    function b() {
      ...
      for (i && clearTimeout(i), i = setTimeout(function () {
        i = null
      }, 500), n = 0; n < o; ++n) (e = f[r[n].identifier]) && (Bt(), e('end'))
    }
    function m(n, e, r, i, o) {
      ...
      if (kt(new Xt(d, 'beforestart', a, n, l, p[0], p[1], 0, 0, v), function () {
        ...
        kt(new Xt(d, u, a, n, s, p[0] + c, p[1] + h, p[0] - g[0], p[1] - g[1], v), v.apply, v, [
          u,
          i,
          o
        ])
  ...
  t.forceCenter = function (t, n) {
    ...
    function r() {
      ...
      a = 0,
      u = 0;
      for (r = 0; r < o; ++r) a += (i = e[r]).x,
      u += i.y;
      for (a = a / o - t, u = u / o - n, r = 0; r < o; ++r) (i = e[r]).x -= a,
      i.y -= u
    }
    return null == t && (t = 0),
    null == n && (n = 0),
  ...
  t.forceCollide = function (t) {
    ...
    i = 1;
    function o() {
      for (var t, o, u, c, f, s, l, h = n.length, d = 0; d < i; ++d) for (o = na(n, oa, aa).visitAfter(a), t = 0; t < h; ++t) u = n[t],
      s = e[u.index],
      l = s * s,
      c = u.x + u.vx,
      f = u.y + u.vy,
      ...
      function p(t, n, e, i, o) {
        ...
        if (a.index > u.index) {
          ...
          v = f - a.y - a.vy,
          g = p * p + v * v;
          g < d * d && (0 === p && (g += (p = Zo()) * p), 0 === v && (g += (v = Zo()) * v), g = (d - (g = Math.sqrt(g))) / g * r, u.vx += (p *= g) * (d = (h *= h) / (l + h)), u.vy += (v *= g) * d, a.vx -= p * (d = 1 - d), a.vy -= v * d)
        }
      }
    }
    function a(t) {
  ...
  t.forceManyBody = function () {
    ...
    function f() {
      if (t) {
        ...
        e,
        o = t.length;
        for (r = new Array(o), n = 0; n < o; ++n) e = t[n],
        r[e.index] = + i(e, n, t)
      }
    }
    function s(t) {
    ...
    function l(t, i, c, f) {
      ...
      h = f - i,
      d = s * s + l * l;
      if (h * h / u < d) return d < a && (0 === s && (d += (s = Zo()) * s), 0 === l && (d += (l = Zo()) * l), d < o && (d = Math.sqrt(o * d)), n.vx += s * t.value * e / d, n.vy += l * t.value * e / d),
      !0;
      if (!(t.length || d >= a)) {
  ...
  t.geoBounds = function (t) {
    ...
    a,
    u;
    if (Pu = Cu = - (Tu = Eu = 1 / 0), Lu = [
    ], cu(t, nc), e = Lu.length) {
      for (Lu.sort(sc), n = 1, o = [
        r = Lu[0]
      ]; n < e; ++n) lc(r, (i = Lu[n]) [0]) || lc(r, i[1]) ? (fc(r[0], i[1]) > fc(r[0], r[1]) && (r[1] = i[1]), fc(i[0], r[1]) > fc(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
  ...
  t.geoCentroid = function (t) {
    ...
    r = $u,
    i = n * n + e * e + r * r;
    return i < qa && (n = Hu, e = ju, r = Xu, Yu < Ra && (n = Bu, e = Fu, r = Iu), (i = n * n + e * e + r * r) < qa) ? [
      NaN,
      NaN
    ] : [
      Ha(e, n) * Ya,
  ...
  t.geoCircle = function () {
    ...
    return a.center = function (t) {
      return arguments.length ? (e = 'function' == typeof t ? t : Mc([ + t[0],
      + t[1]]), a) : e
    },
    a.radius = function (t) {
  ...
  t.geoAlbersUsa = function () {
    ...
    s.translate = function (t) {
      ...
      o = + t[0],
      s = + t[1];
      return e = a.translate(t).clipExtent([[o - 0.455 * n,
      s - 0.238 * n],
      [
        o + 0.455 * n,
        s + 0.238 * n
      ]]).stream(f),
      r = u.translate([o - 0.307 * n,
      s + 0.201 * n]).clipExtent([[o - 0.425 * n + Ra,
      s + 0.12 * n + Ra],
      [
        o - 0.214 * n - Ra,
        s + 0.234 * n - Ra
      ]]).stream(f),
      i = c.translate([o - 0.205 * n,
      s + 0.212 * n]).clipExtent([[o - 0.214 * n + Ra,
      s + 0.166 * n + Ra],
      [
        o - 0.115 * n - Ra,
        s + 0.234 * n - Ra
  ...
  t.geoConicConformal = function () {
    return Cs(Fs).scale(109.5).parallels([30,
    30])
  },
  ...
  t.geoConicEquidistant = function () {
    return Cs(Hs).scale(131.154).center([0,
    13.9389])
  },
  ...
  t.geoIdentity = function () {
    ...
    return o = {
      ...
      clipExtent: function (r) {
        return arguments.length ? (d = null == r ? (h = t = n = e = null, _f) : Vc(h = + r[0][0], t = + r[0][1], n = + r[1][0], e = + r[1][1]), p()) : null == h ? null : [
          [h,
          t],
          [
            n,
      ...
      translate: function (t) {
        return arguments.length ? (l = Qs(a * f, a * s, u = + t[0], c = + t[1]), p()) : [
          u,
          c
        ]
      },
  ...
  t.pack = function () {
    ...
    function i(i) {
      return i.x = n / 2,
      i.y = e / 2,
      t ? i.eachBefore(El(t)).eachAfter(Cl(r, 0.5)).eachBefore(Pl(1)) : i.eachBefore(El(Tl)).eachAfter(Cl(Sl, 1)).eachAfter(Cl(r, i.r / Math.min(n, e))).eachBefore(Pl(Math.min(n, e) / (2 * i.r))),
      i
    }
  ...
  t.stratify = function () {
    ...
    function e(e) {
      ...
      if (o.parent = Dl, o.eachBefore(function (t) {
        t.depth = t.parent.depth + 1,
        --s
      }).eachBefore(fl), o.parent = null, s > 0) throw new Error('cycle');
      return o
    }
  ...
  t.tree = function () {
    ...
    function i(i) {
      var c = function (t) {
        for (var n, e, r, i, o, a = new jl(t, 0), u = [
          a
        ]; n = u.pop(); ) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new jl(r[i], i)),
        e.parent = n;
        return (a.parent = new jl(null, 0)).children = [
          a
        ],
        a
      }(i);
    ...
    function o(n) {
      ...
      n.parent.A = function (n, e, r) {
        if (e) {
          for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Fl(u), o = Bl(o), u && o; ) c = Bl(c),
          (a = Fl(a)).a = n,
          (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Il(Hl(u, n, r), n, i), f += i, s += i),
          l += u.m,
          f += o.m,
          h += c.m,
          s += a.m;
  ...
  t.scaleIdentity = function t(n) {
    ...
    n = arguments.length ? ch.call(n, dh) : [
      0,
      1
    ],
    Nh(r)
  ...
  t.scaleTime = function () {
    return oh.apply(bv(bd, yd, rd, td, Jh, Zh, $h, jh, t.timeFormat).domain([new Date(2000, 0, 1),
    new Date(2000, 0, 2)]), arguments)
  },
  t.scaleUtc = function () {
    return oh.apply(bv(jd, Id, Td, Ad, Md, xd, $h, jh, t.utcFormat).domain([Date.UTC(2000, 0, 1),
  ...
  t.arc = function () {
    ...
    function c() {
      ...
      v = Wg(p - d),
      g = p > d;
      if (u || (u = c = ji()), h < l && (f = h, h = l, l = f), h > ey) if (v > oy - ey) u.moveTo(h * Qg(d), h * ty(d)),
      u.arc(0, 0, h, d, p, !g),
      l > ey && (u.moveTo(l * Qg(p), l * ty(p)), u.arc(0, 0, l, p, d, g));
       else {
        var y,
        _,
        b = d,
        ...
        if (S > ey) {
          var C = ay(S / l * ty(A)),
          P = ay(S / h * ty(A));
          (M -= 2 * C) > ey ? (x += C *= g ? 1 : - 1, w -= C) : (M = 0, x = w = (d + p) / 2),
          (N -= 2 * P) > ey ? (b += P *= g ? 1 : - 1, m -= P) : (N = 0, b = m = (d + p) / 2)
        }
        var z = h * Qg(b),
        R = h * ty(b),
        q = l * Qg(w),
        ...
        if (k > ey) {
          ...
          if (v < ry && (L = function (t, n, e, r, i, o, a, u) {
            ...
            l = u - o,
            h = l * c - s * f;
            if (!(h * h < ey)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c,
            n + h * f]
          }(z, R, Y, B, U, O, q, D))) {
            var F = z - L[0],
            I = R - L[1],
        ...
        N > ey ? E > ey ? (y = hy(Y, B, z, R, h, E, g), _ = hy(U, O, q, D, h, E, g), u.moveTo(y.cx + y.x01, y.cy + y.y01), E < k ? u.arc(y.cx, y.cy, E, Zg(y.y01, y.x01), Zg(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, E, Zg(y.y01, y.x01), Zg(y.y11, y.x11), !g), u.arc(0, 0, h, Zg(y.cy + y.y11, y.cx + y.x11), Zg(_.cy + _.y11, _.cx + _.x11), !g), u.arc(_.cx, _.cy, E, Zg(_.y11, _.x11), Zg(_.y01, _.x01), !g))) : (u.moveTo(z, R), u.arc(0, 0, h, b, m, !g)) : u.moveTo(z, R),
        l > ey && M > ey ? T > ey ? (y = hy(q, D, U, O, l, - T, g), _ = hy(z, R, Y, B, l, - T, g), u.lineTo(y.cx + y.x01, y.cy + y.y01), T < k ? u.arc(y.cx, y.cy, T, Zg(y.y01, y.x01), Zg(_.y01, _.x01), !g) : (u.arc(y.cx, y.cy, T, Zg(y.y01, y.x01), Zg(y.y11, y.x11), !g), u.arc(0, 0, l, Zg(y.cy + y.y11, y.cx + y.x11), Zg(_.cy + _.y11, _.cx + _.x11), g), u.arc(_.cx, _.cy, T, Zg(_.y11, _.x11), Zg(_.y01, _.x01), !g))) : u.arc(0, 0, l, w, x, g) : u.lineTo(q, D)
      } else u.moveTo(0, 0);
  ...
  t.symbol = function () {
    ...
    function r() {
      var r;
      if (e || (e = r = ji()), t.apply(this, arguments).draw(e, + n.apply(this, arguments)), r) return e = null,
      r + '' || null
    }
  ...
  t.zoom = function () {
    ...
    function k() {
      if (r.apply(this, arguments)) {
        ...
        if (n && (n = clearTimeout(n), !u.touch1)) return u.end(),
    ...
    function T() {
      ...
      c = t.event.changedTouches,
      s = c.length;
      for (Sb(), n && (n = clearTimeout(n)), e = 0; e < s; ++e) i = Yt(this, c, (r = c[e]).identifier),
    ...
    function E() {
      ...
      a = o.length;
      for (Ab(), e && clearTimeout(e), e = setTimeout(function () {
        e = null
      }, p), n = 0; n < a; ++n) r = o[n],
    ...
    y.extent = function (t) {
      return arguments.length ? (i = 'function' == typeof t ? t : mb([[ + t[0][0],
      + t[0][1]],
      [
        + t[1][0],
        + t[1][1]
